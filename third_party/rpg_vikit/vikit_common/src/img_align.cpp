...
runOptimization(fast_livo::SE3d& model, int levelBegin, int levelEnd)
{
...
computeResiduals (const fast_livo::SE3d& model, bool linearize_system, bool compute_weight_scale)
{
...
{
  new_model = fast_livo::SE3d::exp(x_)*(old_model);
}
