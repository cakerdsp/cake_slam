...
inline bool loadFromRosNs(const ros::NodeHandle &nh, const std::string& ns, vk::AbstractCamera*& cam)
{
  auto ns_ = ns;
  if (ns_ != "") {
    ns_ = ns_ + ".";
  ...
  else if(cam_model == "MEI")
  {
    cam = new vk::MEICamera(
        getParam<int>(nh, ns_+"width"),
        getParam<int>(nh, ns_+"height"),
        getParam<double>(nh, ns_+"scale", 1.0),
        getParam<double>(nh, ns_+"fx"),
        ...
        getParam<double>(nh, ns_+"cx"),
        getParam<double>(nh, ns_+"cy"),
        getParam<double>(nh, ns_+"xi"),
        getParam<double>(nh, ns_+"k1", 0.0),
        getParam<double>(nh, ns_+"k2", 0.0),
        getParam<double>(nh, ns_+"p1", 0.0),
        getParam<double>(nh, ns_+"p2", 0.0));
  }
  else
  {
    cam = NULL;
...
inline bool loadFromRosNs(const ros::NodeHandle &nh, const std::string& ns, std::vector<vk::AbstractCamera*>& cam_list)
{
  auto ns_ = ns;
  if (ns_ != "") {
    ns_ = ns_ + ".";
