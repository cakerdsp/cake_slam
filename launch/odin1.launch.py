...
def generate_launch_description():
    default_config = PathJoinSubstitution(
        [FindPackageShare("cake_slam"), "config", "odin1.yaml"]
    )
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                ...
                description="Path to the Odin1 cake_slam OpenCV YAML config.",
            ),
            DeclareLaunchArgument(
                "rviz_config",
            ...
            Node(
                ...
                name="cake_slam_odin1",
                output="screen",
                parameters=[
                    {"config_file": config_file, "use_sim_time": use_sim_time_value}
                ],
            ),
            Node(
                package="rviz2",
