...
def generate_launch_description():
    default_config = PathJoinSubstitution(
        [FindPackageShare("cake_slam"), "config", "fast_livo2_hilti22.yaml"]
    )
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                ...
                description="Path to the FAST-LIVO2 HILTI22 cake_slam OpenCV YAML config.",
            ),
            DeclareLaunchArgument(
                "rviz_config",
            ...
            Node(
                ...
                name="cake_slam_fast_livo2_hilti22",
                output="screen",
