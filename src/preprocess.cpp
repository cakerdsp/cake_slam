...
void Preprocess::process(const livox_ros_driver2::msg::CustomMsg::Ptr &msg, PointCloudXYZI::Ptr &pcl_out)
{
  avia_handler(msg);
  *pcl_out = pl_surf;
}
...
void Preprocess::avia_handler(const livox_ros_driver2::msg::CustomMsg::Ptr &msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
...
void Preprocess::Pandar128_handler(const sensor_msgs::msg::PointCloud2::ConstPtr &msg)
{
  pl_surf.clear();
...
void Preprocess::xt32_handler(const sensor_msgs::msg::PointCloud2::ConstPtr &msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
