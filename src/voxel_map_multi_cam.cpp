...
void loadVoxelConfig(ros::NodeHandle &nh, VoxelMapConfig &voxel_config)
{
  ...
  // get parameter
  getRosParam(nh, "publish.pub_plane_en", voxel_config.is_pub_plane_map_);
  getRosParam(nh, "lio.max_layer", voxel_config.max_layer_);
  getRosParam(nh, "lio.voxel_size", voxel_config.max_voxel_size_);
  getRosParam(nh, "lio.min_eigen_value", voxel_config.planner_threshold_);
  ...
  getRosParam(nh, "local_map.map_sliding_en", voxel_config.map_sliding_en);
  getRosParam(nh, "local_map.half_map_size", voxel_config.half_map_size);
  getRosParam(nh, "local_map.sliding_thresh", voxel_config.sliding_thresh);
}
                                     ...
                                     const float alpha, const Eigen::Vector3d rgb)
{
  ...
  plane.color.g = rgb(1);
  plane.color.b = rgb(2);
  plane.lifetime = ros::Duration(0.01);
