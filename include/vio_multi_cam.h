...
public:
  ...
  SE3 ref_patch_dump_range_T_f_w_;
  ...
  bool createVirtualFeaturePatch(const PerCameraData &ctx, const cv::Mat &raw_img, const SE3 &T_c_w,
  ...
  bool buildRefPatchDumpWarpPatches(const PerCameraData &ctx, const cv::Mat &raw_img, const V2D &raw_px,
                                    const V3D &point_c, const SE3 &T_v_w, const cv::Mat &virtual_support_img,
  ...
  bool computeManagedFootprint(const PerCameraData &ctx, const SE3 &T_c_w, const V3D &point_w,
