...
struct VisionConfig
{
  ...
  bool vio_state_feedback_enable = false;  ///< Allow VIO pose feedback into LIO in LIVO mode.
  int min_vio_feedback_visual_residuals = 20; ///< Required visual residuals before VIO may correct LIO pose.
